...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 16));
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));
var _router = __webpack_require__(/*! @/common/router.js */ 19);


var _common = _interopRequireDefault(__webpack_require__(/*! @/common/common.js */ 29));
var _api = _interopRequireDefault(__webpack_require__(/*! @/common/api.js */ 30));
var _request = __webpack_require__(/*! @/common/request.js */ 31);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}



_request.req.baseuUrl = "http://192.168.0.6:80";
_request.req.defaultReq.url = _request.req.baseuUrl + '/api/';
var USERINFO = _common.default.getUserInfo();
function setReqBaseDaata() {
  USERINFO = _common.default.getUserInfo();
  _request.req.defaultReq.type = "POST";
  var user_id = "",user_token = "";
  if (USERINFO) {
    user_id = USERINFO.id;
    user_token = USERINFO.token;
  }
  _request.req.defaultReq.baseData = {
    "user_id": user_id,
    "token": user_token };
  ...
  _request.req.defaultReq.header = {
    'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8' };

}
setReqBaseDaata();

_request.req.defaultReq.beforeSend = function (request) {
  USERINFO = _common.default.getUserInfo();
  if (!request.filter) {
    return request;
  } else {
    if (USERINFO) {
      ...
      for (var key in _router.router.routers) {
        for (var i = 0; i < _router.router.routers[key].length; i++) {var _router$routers$key$i =
          _router.router.routers[key][i],name = _router$routers$key$i.name,path = _router$routers$key$i.path;
          if (path == "/" + page.route) {
            _router.router.push({ "name": "login", params: { "from": name } });
          }
        }
      }
    }
...
myAjax(_x) {return _myAjax.apply(this, arguments);}function _myAjax() {_myAjax = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(options) {var defaults, res, _res$data, data, code, msg, _res, _data;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
            defaults = Object.assign({
              path: "",
              title: "",
              data: {} },
            options);_context.prev = 1;_context.next = 4;return (

              _request.req.ajax({
                path: defaults.path,
                title: defaults.title,
                data: defaults.data,
                abortFun: function abortFun(info, bt) {
                  if (defaults.filter && defaults.filter()) {
                    bt.abort();
                  }
                } }));case 4:res = _context.sent;_res$data =
            ...
            }_context.next = 18;break;case 9:_context.prev = 9;_context.t0 = _context["catch"](1);

            console.log(_context.t0);
            _res = _context.t0.description ? _context.t0.description : _context.t0;
            _data = _res.data;if (!(
            _data.code == 401)) {_context.next = 17;break;}
            uni.showToast({
              title: _data.msg,
              icon: 'none',
              success: function success() {
            ...
            defaults.fail && defaults.fail(_context.t0);case 18:case "end":return _context.stop();}}}, _callee, this, [[1, 9]]);}));return _myAjax.apply(this, arguments);}




_router.router.beforeEach(function (to, from, next) {
  USERINFO = _common.default.getUserInfo();
  if (!to.filter) {
    if (!USERINFO) {
      next({
...
function appLaunch() {// 强制登录
  USERINFO = _common.default.getUserInfo();
  if (!USERINFO) {
    //非NVUE使用路由跳转登录

    _router.router.replaceAll({ "name": "login" });
...
module.exports.$appLaunch = appLaunch;
...
_vue.default.prototype.$ajax = myAjax;
_vue.default.prototype.$appLaunch = appLaunch;
...
var _index = _interopRequireWildcard(__webpack_require__(/*! @/common/uni-simple-router/index.js */ 20));function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;} else {var newObj = {};if (obj != null) {for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) {var desc = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : {};if (desc.get || desc.set) {Object.defineProperty(newObj, key, desc);} else {newObj[key] = obj[key];}}}}newObj.default = obj;return newObj;}}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // import Router from 'uni-simple-router';
...
/***/ 20:
/*!**********************************************************************!*\
  !*** D:/项目/环境监测/envirotronics_app/common/uni-simple-router/index.js ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 16));var util = _interopRequireWildcard(__webpack_require__(/*! ./helpers/util.js */ 21));
...
/***/ 21:
/*!*****************************************************************************!*\
  !*** D:/项目/环境监测/envirotronics_app/common/uni-simple-router/helpers/util.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.resolveRule = exports.encodeURI = exports.normalizeParams = exports.exactRule = exports.parseQuery = exports.queryMp = exports.isH5 = void 0;var _config = __webpack_require__(/*! ./config.js */ 22);
var _warn = __webpack_require__(/*! ./warn.js */ 23);function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};var ownKeys = Object.keys(source);if (typeof Object.getOwnPropertySymbols === 'function') {ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) {return Object.getOwnPropertyDescriptor(source, sym).enumerable;}));}ownKeys.forEach(function (key) {_defineProperty(target, key, source[key]);});}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
/***/ 218:
/*!****************************************************************************!*\
  !*** D:/项目/环境监测/envirotronics_app/components/mescroll-uni/mescroll-uni.js ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 219:
/*!***********************************************************************************!*\
  !*** D:/项目/环境监测/envirotronics_app/components/mescroll-uni/mescroll-uni-option.js ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 22:
/*!*******************************************************************************!*\
  !*** D:/项目/环境监测/envirotronics_app/common/uni-simple-router/helpers/config.js ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 23:
/*!*****************************************************************************!*\
  !*** D:/项目/环境监测/envirotronics_app/common/uni-simple-router/helpers/warn.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 24:
/*!********************************************************************************!*\
  !*** D:/项目/环境监测/envirotronics_app/common/uni-simple-router/lifeCycle/hooks.js ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.resolveRouterHooks = exports.resolveBeforeHooks = exports.resolveAfterHooks = exports.resolveParams = exports.isNext = exports.executeHook = exports.registerHook = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 16));var _util = __webpack_require__(/*! ../helpers/util.js */ 21);
...
/***/ 25:
/*!************************************************************************************!*\
  !*** D:/项目/环境监测/envirotronics_app/common/uni-simple-router/patch/applets-patch.js ***!
  \************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 26:
/*!******************************************************************************!*\
  !*** D:/项目/环境监测/envirotronics_app/common/uni-simple-router/helpers/event.js ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 27:
/*!*******************************************************************************!*\
  !*** D:/项目/环境监测/envirotronics_app/common/uni-simple-router/patch/h5-patch.js ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 28:
/*!********************************************************************************!*\
  !*** D:/项目/环境监测/envirotronics_app/common/uni-simple-router/patch/app-patch.js ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 4:
/*!***********************************************!*\
  !*** D:/项目/环境监测/envirotronics_app/pages.json ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 62:
/*!********************************************************************!*\
  !*** D:/项目/环境监测/envirotronics_app/components/u-charts/u-charts.js ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/index": {}, "pages/index/article": { "navigationBarTitleText": "文章详情" }, "pages/realtime/realtime": { "navigationBarTitleText": "实时数据", "scrollIndicator": "none", "softinputNavBar": "none", "softinputMode": "adjustResize" }, "pages/realtime/realtime-detail/realtime-detail": { "navigationBarTitleText": "项目名称" }, "pages/cloudmap/cloudmap": { "navigationStyle": "custom" }, "pages/monitor/monitor": { "navigationBarTitleText": "视频监控", "bounce": "none", "scrollIndicator": "none", "softinputNavBar": "none", "softinputMode": "adjustResize" }, "pages/cloudmap/video/video": { "navigationBarTitleText": "实时视频", "bounce": "none", "scrollIndicator": "none", "softinputNavBar": "none", "softinputMode": "adjustResize" }, "pages/analysis/analysis": { "navigationBarTitleText": "分析排名", "bounce": "none", "scrollIndicator": "none", "softinputNavBar": "none", "softinputMode": "adjustResize" }, "pages/analysis/analysis-detail/analysis-detail": { "navigationBarTitleText": "详情" }, "pages/alarm/alarm": { "navigationBarTitleText": "报警监管", "bounce": "none", "scrollIndicator": "none", "softinputNavBar": "none", "softinputMode": "adjustResize" }, "pages/alarm/alarm-details/alarm-details": { "navigationBarTitleText": "报警详情" }, "pages/site/site": { "navigationBarTitleText": "现场管理", "bounce": "none", "scrollIndicator": "none", "softinputNavBar": "none", "softinputMode": "adjustResize" }, "pages/site/put-out/put-out": { "navigationBarTitleText": "发布" }, "pages/site/site-details/site-details": { "navigationBarTitleText": "现场详情" }, "pages/user/login": { "navigationBarTitleText": "" }, "pages/user/user": { "navigationBarTitleText": "个人中心" }, "pages/user/change": { "navigationBarTitleText": "修改姓名" } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "环境监测", "navigationBarBackgroundColor": "#FFFFFF", "backgroundColor": "#FFFFFF" } };exports.default = _default;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__0023211" };exports.default = _default;
